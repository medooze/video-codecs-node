 ...
 *  | "webp"
 * )} Codec
 * (keep in sync with `VideoCodec::GetCodecForName` `codecs.h`)
 * this is lowercase for compatibility with the ABR schema;
 * it can actually be any case.
 */
...
/**
 * @param {Codec} encoderCodec encoder name
 * @param {Codec} codec decoder name
