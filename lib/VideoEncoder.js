...
class VideoEncoder extends Emitter
{
	...
	getStats()
	{
		...
		return {
			...
			maxEncodingTime		: stats.maxEncodingTime,
			avgEncodingTime		: stats.avgEncodingTime,
			maxCapturingTime	: stats.maxCapturingTime,
			avgCapturingTime	: stats.avgCapturingTime,
		};
	}
