...
class VideoEncoder extends Emitter
{
	...
	constructor(codec,params)
	{
		...
		const scaleResolutionToHeigth = params.scaleResolutionToHeigth ? parseInt(params.scaleResolutionToHeigth) : 0;
		const allowedDownScaling = scaleResolutionToHeigth && params.hasOwnProperty("allowSameHeigth")? (params.allowSameHeigth ? 1 : 2) : 0;
		...
		//Init pipe
		console.log(scaleResolutionDownBy, scaleResolutionToHeigth, allowedDownScaling)
		this.pipe.Init(scaleResolutionDownBy, scaleResolutionToHeigth, allowedDownScaling);
		//Set it in encoder
