...
/**
 * @typedef {Object} VideoEncoderIncomingStreamTrackEvents
 * @property {(self: VideoEncoderIncomingStreamTrack) => void} attached
 * @property {(self: VideoEncoderIncomingStreamTrack) => void} detached
 * @property {(self: VideoEncoderIncomingStreamTrack) => void} stopped
 * @property {(muted: boolean) => void} muted
 */

/** @extends {Emitter<VideoEncoderIncomingStreamTrackEvents>} */
class VideoEncoderIncomingStreamTrack extends Emitter
{
